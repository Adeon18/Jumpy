...
class Player(pygame.sprite.Sprite):
    ...
    def load_images(self):
        ...
        self.sitting_frame = self.game.spritesheet.get_image(382, 946, 150, 174)
    ...
    def animation(self):
        ...
        if self.walking:
            if time_passed - self.last_update > 120:
...
class Platform(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.game = game
        # Platform images
        snowy_images = [self.game.spritesheet.get_image(0, 768, 380, 94),
                        self.game.spritesheet.get_image(213, 1764, 201, 100)]
        normal_images = [self.game.spritesheet.get_image(0, 288, 380, 94),
                         self.game.spritesheet.get_image(213, 1662, 201, 100)]
        stone_images = [self.game.spritesheet.get_image(0, 96, 380, 94),
                        self.game.spritesheet.get_image(382, 408, 200, 100)]
        wood_images = [self.game.spritesheet.get_image(0, 960, 380, 94),
                       self.game.spritesheet.get_image(218, 1558, 200, 100)]
        pink_images = [self.game.spritesheet.get_image(0, 576, 380, 94),
...
class Coin(pygame.sprite.Sprite):
    ...
    def load_images(self):
        self.animation = [self.game.spritesheet.get_image(698, 1931, 84, 84),
                       ...
                       pygame.transform.flip(self.game.spritesheet.get_image(897, 1574, 50, 84), True, False),
                       pygame.transform.flip(self.game.spritesheet.get_image(829, 0, 66, 84), True, False)]
...
class Spikey(pygame.sprite.Sprite):
    ...
    def load_images(self):
        self.images_R = [self.game.spritesheet.get_image(704, 1256, 120, 159),
                         self.game.spritesheet.get_image(812, 296, 90, 155)]
        for image in self.images_R:
            image.set_colorkey(BLACK)

        self.images_L = [pygame.transform.flip(self.game.spritesheet.get_image(704, 1256, 120, 159), True, False),
                         pygame.transform.flip(self.game.spritesheet.get_image(812, 296, 90, 155), True, False)]
        for image in self.images_L:
            image.set_colorkey(BLACK)
        self.stand_image = self.game.spritesheet.get_image(814, 1417, 90, 155)
